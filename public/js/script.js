$(document).ready(function(){
    ...
    $("#btnConsultarFecha").click(function (e) { 
        e.preventDefault();
        $('#content').html('<div class="text-center" style="position:relative; top: 50px" role="alert"><img src="imagenes/spiner.gif"/><br/>Procesando, por favor espere...</div>');
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#content').fadeIn(1000).html(response);
